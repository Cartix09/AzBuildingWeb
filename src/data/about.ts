...
export const aboutContent = {
  ...
  intro: {
    az: 'AZBUILDING MMC 2009-cu ildən mülki-sənaye və infrastruktur tikinti sektorunda fəaliyyət göstərir. Şirkət bu dövr ərzində aparıcı tərəfdaşlarla birgə iri miqyaslı mülki tikinti, eləcə də Azərbaycan, Gürcüstan və Ukraynada avtomobil yolu tikintisi layihələrində tikinti və mühəndislik dəstəyi xidmətləri göstərmişdir. AZBUILDING infrastruktur layihələrdə subpodratçı, mülki və sənaye tikintilərində podratçı kimi, o cümlədən fərdi yaşayış evlərinin tikintisində sərmayədar kimi çıxış etmişdir. Şirkətin yanaşması etibarlılıq, vaxtında icra və texniki dəqiqlik prinsiplərinə əsaslanır. AZBUILDING özünü tikinti və infrastruktur sahəsində təcrübəli, çoxprofilli icra tərəfdaşı kimi təqdim edir.',
    ru: 'AZBUILDING MMC работает в сфере гражданско-промышленного и инфраструктурного строительства с 2009 года. За этот период компания совместно с ведущими партнёрами оказывала строительные и инженерные услуги в крупных проектах гражданского строительства, а также в проектах строительства автомобильных дорог в Азербайджане, Грузии и Украине. AZBUILDING участвовала в инфраструктурных проектах в качестве субподрядчика, в гражданском и промышленном строительстве в качестве подрядчика, а также в строительстве индивидуальных жилых домов как инвестор/участник. Подход компании основан на надёжности, своевременном исполнении и технической точности. AZBUILDING позиционирует себя как опытный многопрофильный исполнительный партнёр в сфере строительства и инфраструктуры.',
    en: 'AZBUILDING MMC has operated in the civil-industrial and infrastructure construction sector since 2009. During this period, the company has provided construction and engineering support services together with leading partners in large-scale civil construction works, as well as road construction projects in Azerbaijan, Georgia and Ukraine. AZBUILDING has participated in infrastructure projects as a subcontractor, in civil and industrial construction as a contractor, and in individual residential construction as an investor/participant. The company’s approach is based on reliability, timely execution and technical precision. AZBUILDING presents itself as an experienced, multi-profile execution partner in construction and infrastructure.',
  } as Loc,
  mission: {
