    ...
    <>
      ...
      <div className="sticky top-0 z-40 hidden bg-gold-bar shadow-gold lg:block">
        <div className="container-x flex h-14 items-center justify-between">
          ...
          {/* CTA chip (dark navy on the gold bar) - clean divider + subtle hover */}
          <Link
            to="/contact"
            className="group -mr-6 flex h-14 items-center gap-2 border-l border-white/15 bg-navy-deep px-7 text-sm font-semibold uppercase tracking-wide text-[#F8FAFC] transition-colors hover:bg-navy hover:text-gold md:-mr-12"
          >
